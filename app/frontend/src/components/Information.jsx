  ...
  return (
    <div className="bg-indigo-100">
      <h1 className="flex justify-center py-10 text-5xl font-semibold">
        Bem vindo ao Cash Transfer
      </h1>
      <div className="bg-indigo-100 py-24 sm:py-32 lg:py-2">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="sm:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Uma nova forma de transferir dinheiro
            </p>
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-gray-600">
              Faça transferências entre contas de forma rápida e segura.
              Cadastre-se e comece a transferir dinheiro agora mesmo.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-y-16 md:grid-cols-2 md:gap-x-12 md:gap-y-16">
              ...
              <div className="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                ...
                <div className="sm:min-w-0 sm:flex-1">
                  ...
                  <p className="mt-2 text-base leading-7 text-gray-600">
                    Nossas transferências são instantâneas e você pode enviar
                    dinheiro para qualquer lugar do mundo. Assim que concluída a
                    transferência, o dinheiro estará disponível para o
                    beneficiário.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex flex-col gap-6 sm:flex-row md:flex-col lg:flex-row">
                ...
                <div className="sm:min-w-0 sm:flex-1">
                  ...
                  <p className="mt-2 text-base leading-7 text-gray-600">
                    Você pode fazer transferências de dinheiro a qualquer hora e
                    em qualquer lugar com nosso aplicativo móvel. É fácil e
                    rápido. Baixe agora!
                  </p>
                </div>
              </div>
